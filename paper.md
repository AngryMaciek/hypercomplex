...
Based on the structures and operations above let us define a general scheme for
hypercomplex-based cyptosystems. Having chosen $(N, p, q)$ Bob
...
into $E\in\mathcal{A_q^\lambda}$ with:
